    ...
    <main className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-secondary/10 to-transparent py-12 sm:py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-background/40 via-background/20 to-background/40 dark:from-background/80 dark:via-background/60 dark:to-background/80" />
        </div>
        {/* Pattern Overlay */}
        <div className="absolute inset-0 -z-5 opacity-15 dark:opacity-10">
